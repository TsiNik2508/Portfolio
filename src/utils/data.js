...
export const projects = [
  {
    ...
    exampls: [
      ...
      },
      {
        ...
        subtitle:
          " 'Mesto'- это интерактивный веб-приложение, которое позволяет пользователям делиться своими фотографиями. Пользователи могут добавлять новые карточки с фотографиями, ставить лайки, удалять карточки, редактировать свой профиль, а также имеет формы регистрации и входа.",
